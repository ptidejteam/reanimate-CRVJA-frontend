...
export default function VersionSelector({ children, value, availableVersions, onChange }) {
  ...
  return (
    ...
    >
      ...
      {children && (
        <span style={{ fontWeight: 'bold', fontSize: '14px', color: 'black' }}>{children}</span>
      )}
          ...
          {versions.map((version, index) => (
            <div
              ...
              style={{
                ...
                fontSize: '12px',
                fontWeight: 'bold',
                borderBottom: index < versions.length - 1 ? '1px solid #C0C0C0' : 'none',
              }}
              onMouseEnter={(e) => {
